        ...
        try {
          ...
          if (o.usage && o.usage.total_tokens != null) {
            emit(controller, { or_usage: {
              ...
              cost: typeof o.usage.cost === 'number' && Number.isFinite(o.usage.cost) ? o.usage.cost : null,
            } });
          }
...
let keyCache = { at: 0, info: null, failedAt: 0 };
...
async function keyInfo() {
  ...
  if (Date.now() - keyCache.failedAt < 60 * 1000) throw new Error('OpenRouter recently unreachable');
  try {
    ...
    keyCache = {
      at: Date.now(), failedAt: 0,
      info: {
        usage: typeof d.usage === 'number' ? d.usage : null,        // USD spent on this key
        limit: typeof d.limit === 'number' ? d.limit : null,        // USD cap (null = uncapped)
